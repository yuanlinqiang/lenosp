  ...
  <form class="layui-form layui-form-pane" style="margin-left: 20px;">
    ...
    <div class="layui-form-item">
      ...
      <div class="layui-input-inline">
        ...
        <input type="text"  id="beginTime" value="${leave.beginTime?string("yyyy-MM-dd")}" name="beginTime"  lay-verify="beginTime"  placeholder="yyyy-MM-dd"
    ...
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" id="endTime" value="${leave.endTime?string("yyyy-MM-dd")}" name="endTime" lay-verify="endTime"  placeholder="yyyy-MM-dd"  autocomplete="off" class="layui-input">
      </div>
    </div>
    </div>
      <div class="layui-form-item">
    ...
    <div class="layui-inline">
      ...
      <div class="layui-input-inline">
        <input type="text" id="reason" value="${leave.reason}" style="width: 300px;" name="reason" lay-verify="reason"  autocomplete="off" class="layui-input">
      </div>
    </div>
    </div>
